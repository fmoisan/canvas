...
using namespace Catch;
    ...
    class canvas_reporter : public StreamingReporterBase
    {
    public:

        canvas_reporter( ReporterConfig const & _config )
            : StreamingReporterBase( _config )
            , m_headerPrinted( false )
        {}

        virtual ~canvas_reporter() {}
        ...
        private:
            void printResultType() const {
                if( !passOrFail.empty() ) {
                    ...
                    if (result.isOk() || !result.hasExpression())
                         stream << "\n";
                }
            }
    ...
    INTERNAL_CATCH_REGISTER_REPORTER( "canvas_reporter", canvas_reporter)
